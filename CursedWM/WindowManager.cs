...
namespace CursedWM
{
    ...
    public partial class WindowManager
    {
        ...
        public WindowManager(SimpleLogger.LogLevel level)
        {
            ...
            // Setup colours
            this.Colours.DesktopBackground = GetPixelByName("grey");
        ...
        private void AddFrame(Window child)
        {
            ...
            var menubutton = Xlib.XCreateSimpleWindow(this.display, this.root,
            (int)(attr.width - (title_height)), attr.y, title_height, title_height, inner_border, this.Colours.InactiveTitleColor, this.Colours.WindowBackground);
            ...
            Xlib.XSelectInput(this.display, menubutton, EventMask.ButtonPressMask | EventMask.ButtonReleaseMask);
            ...
            Xlib.XReparentWindow(this.display, menubutton, frame, (int)(attr.width - (title_height)), 0);
            Xlib.XMapWindow(this.display, title);
            Xlib.XMapWindow(this.display, frame);
            Xlib.XMapWindow(this.display, menubutton);
            ...
            var wg = new WindowGroup { child = child, frame = frame, title = title, menubutton = menubutton };
            this.WindowIndexByClient[child] = wg;
            this.WindowIndexByTitle[title] = wg;
            this.WindowIndexByFrame[frame] = wg;
            this.WindowIndexByWMenuButt[menubutton] = wg;
            Switcher.AddWindow(child);
        }
        ...
        private void SnapFrameToEdge(Window frame, int x, int y, uint w, uint h)
        {
            ...
            { // Vertical half screen sized window
                ...
                Xlib.XMoveWindow(this.display, wmenu, (int)(w / 2 - 20), 0);
            }
            else
            { // Horizontal half screen sized window
                ...
                // make sure the wmenu button is always at the top right of the window
                var wmenu = this.WindowIndexByFrame[frame].menubutton;
                Xlib.XMoveWindow(this.display, wmenu, (int)(w - 20), 0);
            }
        ...
        public WindowSwitcher Switcher { get; set; }
        ...
        public int Run()
        {
            ...
            Switcher = new WindowSwitcher(this.display, this.root);
